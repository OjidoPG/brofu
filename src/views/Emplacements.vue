            ...
            <v-row justify="center">
                <v-dialog v-model="dialog2" persistent max-width="290">
                    <v-card>
                        ...
                        <v-card-text>Confirmez-vous la suppression de l'emplacement ?</v-card-text>
                        <v-card-actions>
...
<script>
    export default {
        ...
        methods: {
            ...
            confirmDelete() {
                const index = this.emplacements.indexOf(this.itemStockage);
                this.emplacements.splice(index, 1);
                let formDataDelete = new FormData();
                formDataDelete.append("idEmplacement", this.itemStockage.id);
                this.$http
